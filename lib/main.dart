...
class _MyAppState extends State<MyApp> {
  ...
  themeMode: ThemeMode.light,
              ...
              getPages: [
                ...
                GetPage(name: kdChannels, page: () => const KurdishLiveChannelsScreen(catyId: '1')),
                //GetPage(name: bypassScreen, page: () => const BypassScreen()),
                  //GetPage(name: '/KDScreen', page: () => const KDScreen()),
                //GetPage(name: '/KDchannels', page: () =>  OsnChannelsScreen()),
