...
class _ListChannelsScreen extends State<LiveChannelsScreen> {
  ...
  // Initialize or dispose of the video before starting a new one
                                    ...
                                    children: [
                                      ...
                                      BlocBuilder<FavoritesCubit, FavoritesState>(
                                        builder: (context, state) {
                                          ...
                                          // Use AppBarLive with added logic to stop the video
                                          return AppBarLive(
                                            onChannels: () {
                                              _stopCurrentVideo();
                                            ...
                                            onClose: () {
                                              _stopCurrentVideo();  // Ensure video stops on back
                                              Get.back();
                                            },
                                          );
                                        ...
                                        child: BlocBuilder<ChannelsBloc, ChannelsState>(
                                          builder: (context, state) {
                                            if (state is ChannelsLoading) {
                                              ...
                                              List<ChannelLive> searchList = categories
                                                  .where((element) => element.name!.toLowerCase().contains(keySearch))
                                                  .toList();
